...
public class GerenciaProduto {
    ...
    public void criarProduto(Produto produto){
        String sql = "INSERT INTO produtos(nome, precoUnitario, precoLote, custoProducao, categoria, tamanho, fornecedor, descricao)"
                + " VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        try{
            ...
            stmtProduto.setString(6, produto.getTamanho2());
        ...
        try{
            PreparedStatement stmt = conn.prepareStatement(sql);
                ...
                while(rs.next()){
                    ...
                    produto.setTamanho2(rs.getString("tamanho"));
    ...
    public void atualizarProduto(Produto produto){
        String sql = "UPDATE produtos SET nome = ?, precoUnitario = ?, precoLote = ?, custoProducao = ?, categoria = ?, tamanho = ?, fornecedor = ?, descricao = ? WHERE id = ?";
        try{
            PreparedStatement stmt = conn.prepareStatement(sql);
            ...
            stmt.setString(6,produto.getTamanho2());
